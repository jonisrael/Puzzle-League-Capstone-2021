  ...
  <section id="about-page">
    <body>
      <div>
        ...
        <p>
          I chose to participate in this coding boot camp because I was looking
          for a career change that would allow me to apply my math abilities in
          order to help a company with their business. Remembering that I
          enjoyed some computer science classes in college, I looked into
        ...
        <p>
          For this capstone, I chose to clone a game and design a web
          application around it. The original is a game similar to Tetris called
          Planet Puzzle League. Since video games are a hobby of mine, I grew up
          with this game but it has a very niche following. I wanted to
